...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Colognecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"local test", "192.168.0.11"},
//    {"colognecoinpool.org", "dnsseed.colognecoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Colognecoin is probably already running."), addrBind.ToString().c_str());
        else
